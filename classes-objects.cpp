...
// script to display user profile:
// app.cpp
#include <iostream>
#include "profile.hpp"
int main() {
  Profile bella("Bella Goth", 31, "Pleasantview", "Casanova", "she/her");
  bella.add_hobby("practicing organ");
  bella.add_hobby("loves golfing");
  bella.add_hobby("gardening exotic plants");
  bella.add_hobby("disappering randomly");
  std::cout << bella.view_profile();
}
// profile.cpp
#include <iostream>
#include "profile.hpp"
